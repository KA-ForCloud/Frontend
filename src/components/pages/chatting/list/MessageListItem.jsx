    ...
    return (
        <div>
            ...
            {Number(memberId)!==item.memberId?
                <div className='flex'>
                    <div className='rounded-sm w-fit min-w-fit h-full text-sm font-bold bg-blue-500 text-white ml-3 py-1 px-2'>
                        {item.msg}
                    </div>
                ...
                <div className='flex ml-auto'>
                    ...
                    <div className='rounded-sm w-fit h-full text-sm font-bold bg-sky-300 text-black mr-3 py-1 px-2'>
                        {item.msg}
                    </div>
                </div>
            }
